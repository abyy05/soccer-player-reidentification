...
> Multi-object tracking for football footage — stable player IDs across occlusion, crowd clusters, and frame edges using a custom Kalman filter tracker built on top of a YOLOv8-style PyTorch model.
